...
const COLUMN_PATTERNS: Record<string, string[]> = {
  ...
  buyer_legal_reg_id: ['buyer_legal_reg_id', 'buyer_registration_id', 'buyer_trade_license', 'customer_legal_id', 'supplier_legal_reg_id', 'party_legal_reg_id'],
  buyer_legal_reg_id_type: ['buyer_legal_reg_id_type', 'buyer_registration_type', 'buyer_license_type', 'customer_legal_id_type', 'supplier_legal_reg_id_type', 'party_legal_reg_id_type'],
  ...
  item_gross_price: ['item_gross_price', 'gross_price', 'gross_unit_price', 'unit_gross_price', 'line_gross_price'],
  ...
  line_vat_amount_aed: ['line_vat_amount_aed', 'vat_amount_aed', 'aed_vat_amount', 'line_tax_amount_aed'],
  line_amount_aed: ['line_amount_aed', 'line_total_aed', 'aed_line_amount', 'invoice_line_amount_aed', 'line_amount_in_aed'],
