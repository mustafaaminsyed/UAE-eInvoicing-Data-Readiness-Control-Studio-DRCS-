...
const DR_TO_COLUMN_MAP: Record<string, { dataset: 'buyers' | 'headers' | 'lines'; columns: string[] }> = {
  ...
  'IBG-03': { dataset: 'headers', columns: ['preceding_invoice_reference', 'preceding_invoice_issue_date'] },
  'IBT-025': { dataset: 'headers', columns: ['preceding_invoice_reference'] },
  'IBT-026': { dataset: 'headers', columns: ['preceding_invoice_issue_date'] },
  ...
  'BTAE-14': { dataset: 'headers', columns: ['principal_id'] },
  'IBG-14': { dataset: 'headers', columns: ['invoicing_period_start_date', 'invoicing_period_end_date'] },
  'IBG-13': { dataset: 'headers', columns: ['deliver_to_address_line_1', 'deliver_to_city', 'deliver_to_country_subdivision', 'deliver_to_country_code'] },
  'IBT-075': { dataset: 'headers', columns: ['deliver_to_address_line_1'] },
  'IBT-077': { dataset: 'headers', columns: ['deliver_to_city'] },
  'IBT-079': { dataset: 'headers', columns: ['deliver_to_country_subdivision'] },
  'IBT-080': { dataset: 'headers', columns: ['deliver_to_country_code'] },
...
export const PARSER_KNOWN_COLUMNS: Record<'buyers' | 'headers' | 'lines', Set<string>> = {
  ...
  headers: new Set([
    ...
    'invoicing_period_start_date', 'invoicing_period_end_date',
	    'deliver_to_address_line_1', 'deliver_to_city', 'deliver_to_country_subdivision',
	    'deliver_to_country_code', 'payment_due_date',
	    'payment_means_code', 'fx_rate', 'amount_due', 'tax_category_code',
	    'tax_category_rate', 'credit_note_reason_code', 'credit_note_reason_text', 'preceding_invoice_reference',
	    'preceding_invoice_issue_date', 'note', 'supply_date', 'tax_currency',
