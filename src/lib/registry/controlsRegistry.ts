...
const CONTROLS_DEFINITION: Omit<ControlEntry, 'covered_dr_ids'>[] = [
  ...
  },
  {
    ...
    covered_rule_ids: ['UAE-UC1-CHK-017', 'UAE-UC1-CHK-018', 'UAE-UC1-CHK-019', 'UAE-UC1-CHK-020', 'UAE-UC1-CHK-036', 'UAE-UC1-CHK-037'],
  },
  {
    control_id: 'CTRL-006',
  ...
  },
  {
    ...
    covered_rule_ids: ['UAE-UC1-CHK-030', 'UAE-UC1-CHK-031', 'UAE-UC1-CHK-032', 'UAE-UC1-CHK-033', 'UAE-UC1-CHK-038', 'UAE-UC1-CHK-039'],
  },
  {
    control_id: 'CTRL-013',
