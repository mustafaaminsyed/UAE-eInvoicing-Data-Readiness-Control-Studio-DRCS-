...
INV003,UAE-2025-0003,2025-01-17,381,100000000000001,Dariba Tax Technologies LLC,Al Sila Tower ADGM,Abu Dhabi,AE,AE-AZ,dariba@peppol.ae,TL-123456,TL,B003,AED,01000000,,,,,,,,2025-02-16,30,1.000000,500.00,25.00,525.00,525.00,S,5.00,ADJ,UAE-2024-1099,2024-12-31`;
...
export const TEMPLATE_MANIFEST = {
  ...
  templates: [
    ...
    { file: 'invoice_headers_template.csv', dataset: 'Invoice Headers', columns: 35 },
