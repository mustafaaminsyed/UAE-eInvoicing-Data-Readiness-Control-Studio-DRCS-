...
export const PINT_AE_UC1_FIELDS: PintAEField[] = [
  ...
  { id: 'preceding_invoice_reference', name: 'Preceding Invoice Reference', description: 'Original invoice reference for credit notes', ibtReference: 'IBT-025', category: 'header', isMandatory: false, dataType: 'string' },
  { id: 'preceding_invoice_issue_date', name: 'Preceding Invoice Issue Date', description: 'Issue date of the original invoice being credited', ibtReference: 'IBT-026', category: 'header', isMandatory: false, dataType: 'date', format: 'YYYY-MM-DD' },
